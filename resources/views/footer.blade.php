<div class = "w-full bg-purple-900 h-[280px] text-white flex flex-row pt-12" >
    ...
    <div class = "w-3/12 pl-28 flex flex-col">
        <span class = "font-inter font-bold text-lg ">Follow us</span>
        <a href="https://www.instagram.com/tedyyad_" class = "font-normal text-lg mt-4 hover:underline">Instagram</a>
        <a href="https://discord.gg/ggt8zCD3aQ" class = "font-normal text-lg mt-4 hover:underline">Discord</a>
    </div>
</div>